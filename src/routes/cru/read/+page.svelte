<script>
	import { HippoWhiteFrame, HippoSearchHeader, HippoSort, HippoPagination } from '$lib/components/hippocomponent';
  import { Table, TableBody, TableBodyCell,
    TableBodyRow, TableHead, TableHeadCell } from '$lib/components/helpers';
...
<SetupFrame id="script">
  ...
  <code><span class="import-from">import</span> &#123 HippoWhiteFrame, HippoSearchHeader, HippoSort, HippoPagination &#125 <span class="import-from">from</span> "$lib/components/hippocomponent";</code>
...
<CodeExampleFrame name="조회프레임">
  <HippoWhiteFrame class="px-8 py-6">
    <HippoSearchHeader firstName="히포" secondName="티앤" thirdName="씨이"
      hasSecondButton={true} on:onFirst={firstFunction}
      on:onSecond={secondFunction}>버튼 
    </HippoSearchHeader>
  </HippoWhiteFrame>
    ...
    <Table hoverable=true>
      <TableHead>
          {#each tableHeader as th}
            ...
            {:else}
              <TableHeadCell textClass="text-[#303030] text-[13px] text-start">{th.name}</TableHeadCell>
            {/if}
          {/each}
        </TableHead>
...
<code>&lt<span class="component">HippoWhiteFrame</span> class="p-5 mt-8" &gt</code>
  <code>&lt<span class="component">HippoSearchHeader</span> firstName="히포" secondName="티앤" thirdName="씨이"
...
<code>&lt<span class="component">HippoWhiteFrame</span> class="p-5 mt-8" &gt</code>
  ...
  <code>&ltdiv class="flex justify-center w-full mt-8"&gt</code>
    <code>&lt<span class="component">HippoPagination</span> &#123totalCount&#125 &#123perPage&#125 /&gt</code>
  <code>&lt/div&gt</code>
<code>&lt/<span class="component">HippoWhiteFrame</span> &gt</code>
</pre>
</CodeBox>