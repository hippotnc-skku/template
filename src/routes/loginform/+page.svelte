<script>
	...
	import HippoCheckBox from '$lib/components/hippocomponent/checkbox/HippoCheckBox.svelte';
	import HippoNavyButton from '$lib/components/hippocomponent/button/HippoNavyButton.svelte';
	import HippoTextButton from '$lib/components/hippocomponent/button/HippoTextButton.svelte';
...
<div class="flex justify-center items-center h-full w-full background">
	...
	<!-- <div
		class="bg-white rounded-xl z-10 text-[#303030] w-full sm:max-w-[26.5rem] mx-2 sm:mx-0 px-8 sm:px-10 pt-10 pb-14 flex flex-col shadow-soft-sm"
	>
