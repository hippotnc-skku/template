...
<HippoWhiteFrame class="text-center py-5 px-10 w-full space-y-2">
	...
	<div class="text-start">
		<div class="mb-4 mt-5 font-bold">Default값</div>
		<div class="text-sm space-y-1">
			<div>needButtons: true (버튼 그룹 유무)</div>
			<div>firstName: "첫번째" (버튼 유무)</div>
			<div>secondName: "두번째" (버튼 유무)</div>
			<div>thirdName: "세번째" (버튼 유무)</div>
			<div>hasSecondButton: false (두번째 버튼 유무)</div>
			<div>hasThirdButton: false (세번째 버튼 유무)</div>
...
<SetupFrame>
  ...
  <code
			><span class="import-from">import</span> &#123 HippoSearchHeader &#125 <span
...
<CodeBox class="mt-10" id="triple">
	<pre id="triple"><code
			>&lt<span class="component">HippoSearchHeader</span
			> firstName="히포" secondName="티앤" thirdName="씨이"
    hasSecondButton=&#123true&#125 hasThirdButton=&#123true&#125 <span class="function-event"
				>on:onFirst=&#123firstFunction&#125</span
			>
