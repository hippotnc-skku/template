<script lang="ts">
	...
	function confirmBillState() {
		notifications.success('함수 실행 성공', 1500);
			...
			<svelte:fragment slot="footer">
				<form method="POST" action="">
					...
					<HippoButton
						color="green"
						on:click={() => {
							notifications.success('폼 제출 성공', 1500);
							editFamilyModal = false;
						}}>수정</HippoButton
					>
				</form>
...
<CodeExampleFrame name="Code1">
	<iframe
		...
		src="https://emgithub.com/iframe.html?target=https%3A%2F%2Fgithub.com%2Fhippotnc-skku%2Ftemplate%2Fblob%2Fcomponent%2Fsrc%2Froutes%2F%28template%29%2Fmodal%2F_temp.svelte%3Fts%3D4%23L1-L62&style=a11y-dark&type=code&showBorder=on&showLineNumbers=on&showFullPath=on&showCopy=on"
	></iframe>
</CodeExampleFrame>
...
<CodeExampleFrame name="Code2">
	<iframe
		...
		allow="clipboard-write"
		src="https://emgithub.com/iframe.html?target=https%3A%2F%2Fgithub.com%2Fhippotnc-skku%2Ftemplate%2Fblob%2Fcomponent%2Fsrc%2Froutes%2F%28template%29%2Fmodal%2F_temp2.svelte%3Fts%3D4%23L1-L17&style=a11y-dark&type=code&showBorder=on&showLineNumbers=on&showFullPath=on&showCopy=on"
	></iframe>
</CodeExampleFrame>
